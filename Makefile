...
PKG_SOURCES	=  tclmixer.c
PKG_OBJECTS	=  tclmixer.o
...
PKG_LIB_FILE	= libtclmixer2.0.1.so
PKG_LIB_FILE8	= libtclmixer2.0.1.so
PKG_LIB_FILE9	= libtcl9tclmixer2.0.1.so
PKG_STUB_LIB_FILE = libtclmixerstub2.0.1.a
...
top_builddir	= /home/danilo/Public/tclmixer
...
INCLUDES	=  -I/usr/include/SDL2 -D_REENTRANT -I"/usr/include" -I.
#INCLUDES	=  -I/usr/include/SDL2 -D_REENTRANT -I"/usr/include" @TK_INCLUDES@ @TK_XINCLUDES@
...
# compiled with.
#DEFS		= $(TCL_DEFS) -DPACKAGE_NAME=\"tclmixer\" -DPACKAGE_TARNAME=\"tclmixer\" -DPACKAGE_VERSION=\"2.0.1\" -DPACKAGE_STRING=\"tclmixer\ 2.0.1\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DBUILD_tclmixer=/\*\*/ -DHAVE_STDIO_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_STRINGS_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_UNISTD_H=1 -DSTDC_HEADERS=1 -DTcl_Size=int -DUSE_THREAD_ALLOC=1 -D_REENTRANT=1 -D_THREAD_SAFE=1 -DTCL_THREADS=1 -DUSE_TCL_STUBS=1 -DUSE_TCLOO_STUBS=1 -DMODULE_SCOPE=extern\ __attribute__\(\(__visibility__\(\"hidden\"\)\)\) -DHAVE_HIDDEN=1 -DHAVE_CAST_TO_UNION=1 -DHAVE_STDBOOL_H=1 -DTCL_WIDE_INT_IS_LONG=1 -DTCL_CFG_OPTIMIZED=1 -DTCL_MAJOR_VERSION=8 $(PKG_CFLAGS)
DEFS		= -DPACKAGE_NAME=\"tclmixer\" -DPACKAGE_TARNAME=\"tclmixer\" -DPACKAGE_VERSION=\"2.0.1\" -DPACKAGE_STRING=\"tclmixer\ 2.0.1\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DBUILD_tclmixer=/\*\*/ -DHAVE_STDIO_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_STRINGS_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_UNISTD_H=1 -DSTDC_HEADERS=1 -DTcl_Size=int -DUSE_THREAD_ALLOC=1 -D_REENTRANT=1 -D_THREAD_SAFE=1 -DTCL_THREADS=1 -DUSE_TCL_STUBS=1 -DUSE_TCLOO_STUBS=1 -DMODULE_SCOPE=extern\ __attribute__\(\(__visibility__\(\"hidden\"\)\)\) -DHAVE_HIDDEN=1 -DHAVE_CAST_TO_UNION=1 -DHAVE_STDBOOL_H=1 -DTCL_WIDE_INT_IS_LONG=1 -DTCL_CFG_OPTIMIZED=1 -DTCL_MAJOR_VERSION=8 $(PKG_CFLAGS)
...
CPPFLAGS	= 
LIBS		=  -L/usr/lib64 -lSDL2 -lSDL2_mixer 
AR		= ar
